...
<body>
  ...
  <div class="container-fluid">
    ...
    <a href="?halaman=<?= $halamanAktif - 1; ?>" style="text-decoration: none;">Back</a>
    <?php endif; ?>


    <?php for ($i = 1; $i <= $jumlahHalaman; $i++) : ?>
    <?php if ($i == $halamanAktif) : ?>
    <a href="?halaman=<?= $i; ?>" style="font-weight: bold; color:#008CBA; text-decoration: none;"><?= $i; ?></a>
    <?php else : ?>
    ...
    <a href="?halaman=<?= $halamanAktif + 1 ?>" style="text-decoration: none;">Next</a>
    <?php endif; ?>
